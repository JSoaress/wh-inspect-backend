...
export class UserPgMapper implements IDbMapper<User, PgUserDTO> {
    ...
    constructor() {
        this.filterOptions = {
            columns: {
                ...
                lastLogin: { columnName: "last_login", type: "date" },
    ...
    toDomain(persistence: PgUserDTO): User {
        return UserEntityFactory.restore({
            ...
            lastLogin: persistence.last_login,
    ...
    toPersistence(entity: User): Partial<PgUserDTO> {
        return {
            ...
            last_login: entity.isNew || entity.checkDirtyProps("lastLogin") ? entity.lastLogin : undefined,
