...
import { ProjectSlugTakenError, ValidationError } from "@/app/_common";
...
export type CreateProjectUseCaseOutput = Either<ValidationError | ProjectSlugTakenError, ProjectCreatedDTO>;
